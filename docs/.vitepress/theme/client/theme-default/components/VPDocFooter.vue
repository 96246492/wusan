...
// console.log(page.value) // 文章页的全部数据
...
const hasLastUpdated = computed(() => {
    // console.log(page.value.lastUpdated, frontmatter.value.lastUpdated);
    return page.value.lastUpdated && frontmatter.value.lastUpdated !== false
})

const showFooter = computed(() => {

    // console.log(hasEditLink.value, hasLastUpdated.value, control.value.prev, control.value.next)
